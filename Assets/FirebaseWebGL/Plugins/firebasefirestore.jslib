mergeInto(LibraryManager.library, {
	...
	QueryDB: function (collectionPath, fieldName, Type,objectName, callback, fallback) {
        var parsedPath = Pointer_stringify(collectionPath);
        var parsedFieldName = Pointer_stringify(fieldName);
        var parsedType = Pointer_stringify(Type);
		var parsedObjectName = Pointer_stringify(objectName);
        var parsedCallback = Pointer_stringify(callback);
        var parsedFallback = Pointer_stringify(fallback);
